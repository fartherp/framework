 ...
 * @author manhong.yqd
 */
public class FrameworkSerializable {
    public static final Charset CHARSET_UTF8 = Charset.forName("UTF-8");

    public static byte[] frameworkrotocolEncode(RemotingCommand cmd) {
        // String remark
    ...
    public static RemotingCommand frameworkProtocolDecode(final byte[] headerArray) {
