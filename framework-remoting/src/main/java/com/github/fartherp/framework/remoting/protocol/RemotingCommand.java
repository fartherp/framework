...
import com.github.fartherp.framework.remoting.CommandCustomHeader;
...
public class RemotingCommand {
    public static final String SERIALIZE_TYPE_PROPERTY = "framework.serialize.type";
    public static final String SERIALIZE_TYPE_ENV = "FRAMEWORK_SERIALIZE_TYPE";
    ...
    public static final String REMOTING_VERSION_KEY = "framework.remoting.version";
    ...
    private static RemotingCommand headerDecode(byte[] headerData, SerializeType type) {
        switch (type) {
            case JSON:
                ...
                return resultJson;
            case Framework:
                RemotingCommand resultRMQ = FrameworkSerializable.frameworkProtocolDecode(headerData);
    ...
    private byte[] headerEncode() {
        ...
        if (SerializeType.Framework == serializeTypeCurrentRPC) {
            return FrameworkSerializable.frameworkrotocolEncode(this);
        } else {
