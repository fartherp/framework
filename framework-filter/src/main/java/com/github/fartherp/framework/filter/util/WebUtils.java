...
public class WebUtils {
    ...
    public static final String SERVLET_REQUEST_KEY = ServletRequest.class.getName() + "_FRAME_THREAD_CONTEXT_KEY";
    public static final String SERVLET_RESPONSE_KEY = ServletResponse.class.getName() + "_FRAME_THREAD_CONTEXT_KEY";


    public static final String SAVED_REQUEST_KEY = "FrameworkSavedRequest";
