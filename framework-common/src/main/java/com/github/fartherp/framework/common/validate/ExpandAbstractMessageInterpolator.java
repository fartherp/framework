...
public abstract class ExpandAbstractMessageInterpolator implements MessageInterpolator {
    ...
    public ExpandAbstractMessageInterpolator(Locale locale) {
        this( null , locale);
    }

    public ExpandAbstractMessageInterpolator(ResourceBundleLocator userResourceBundleLocator, Locale locale) {
        this( userResourceBundleLocator, null , locale);
    }
     ...
     * @since 5.2
     */
    public ExpandAbstractMessageInterpolator(ResourceBundleLocator userResourceBundleLocator,
                                             ResourceBundleLocator contributorResourceBundleLocator, Locale locale) {
        this( userResourceBundleLocator, contributorResourceBundleLocator, true , locale);
    }
    ...
    public ExpandAbstractMessageInterpolator(ResourceBundleLocator userResourceBundleLocator,
                                             ...
                                             boolean cacheMessages, Locale locale) {
        //  TODO 通过前端传递的参数来显示国际化
